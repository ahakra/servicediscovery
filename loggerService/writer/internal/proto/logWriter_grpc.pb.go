...
func (c *logwriterClient) SaveLog(ctx context.Context, in *LogData, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedLogwriterServer) SaveLog(context.Context, *LogData) (*emptypb.Empty, error) {
...
func _Logwriter_SaveLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogwriterServer).SaveLog(ctx, req.(*LogData))
	}
