...
var ServiceDiscoveryInit_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/serviceDiscoveryProto/servicediscovery.proto",
}
...
type ServiceDiscoveryInfoClient interface {
	...
	GetServiceByName(ctx context.Context, in *ServiceName, opts ...grpc.CallOption) (*Services, error)
}
...
func (c *serviceDiscoveryInfoClient) GetServiceByName(ctx context.Context, in *ServiceName, opts ...grpc.CallOption) (*Services, error) {
	out := new(Services)
	err := c.cc.Invoke(ctx, "/protogen.ServiceDiscoveryInfo/GetServiceByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceDiscoveryInfoServer interface {
	...
	GetServiceByName(context.Context, *ServiceName) (*Services, error)
...
func (UnimplementedServiceDiscoveryInfoServer) GetServiceByName(context.Context, *ServiceName) (*Services, error) {
...
func _ServiceDiscoveryInfo_GetServiceByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServiceName)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceDiscoveryInfoServer).GetServiceByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protogen.ServiceDiscoveryInfo/GetServiceByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceDiscoveryInfoServer).GetServiceByName(ctx, req.(*ServiceName))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceDiscoveryInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ServiceDiscoveryInfo_GetServiceByName_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/serviceDiscoveryProto/servicediscovery.proto",
